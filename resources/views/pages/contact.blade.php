...
@section('content')
<!-- Banner start -->
<div class="bg-emerald-900 pt-16 pb-32 flex content-center items-center justify-center"
                ...
                <div class="flex flex-wrap justify-between mb-12 lg:mb-0">
                  ...
                  <div class="flex max-w-full w-[330px] mb-8">
                    ...
                    <div>
                      ...
                      <p class="text-base text-body-color"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e48d8a828ba49d8b9196808b89858d8aca878b89">[email&#160;protected]</a></p>
                      <p class="text-base text-body-color">
                        <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b0d3dfdec4d1d3c4f0c9dfc5c2d4dfddd1d9de9ed3dfdd">[email&#160;protected]</a>
                      </p>
                    </div>
                  </div>
                </div>
