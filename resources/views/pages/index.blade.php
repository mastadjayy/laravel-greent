            ...
            <div class="flex flex-wrap -mx-4 -mb-10 text-center">
              <div class="sm:w-6/12 mb-10 px-4">
                ...
                <p class="leading-relaxed text-slate-300">
                  Le Substrat-GT est un produit utilisé dans la technique de culture en pots. Ce substrat  à la fois aéré, drainant, stable et rétenteur d’eau favorise le développement racinaire des jeunes plants.
                </p>
              </div>
              <div class="sm:w-6/12 mb-10 px-4">
                <div class="rounded-lg h-64 overflow-hidden">
                ...
                <p class="leading-relaxed text-slate-300">
                  Le Cocochips-GT est un produit utilisé dans différents types de culture. Ce produit  à la fois aéré, drainant, stable et détenteur d’eau favorise un bon enracinement de la plante.
                </p>
              </div>
            </div>
          </div>
